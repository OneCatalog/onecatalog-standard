...
| PrestaShop (8.x) | 📦 [в репо](https://github.com/OneCatalog/onecatalog-prestashop/blob/dev/docs/integration-plan.md) | 📦 [в репо](https://github.com/OneCatalog/onecatalog-prestashop/blob/dev/docs/integration-answers.md) | 🚧 [onecatalog-prestashop](https://github.com/OneCatalog/onecatalog-prestashop) (в разработке, ветка `dev`) |
...
| Magento 2.4.x | 📦 [в репо](https://github.com/OneCatalog/onecatalog-magento/blob/dev/docs/integration-plan.md) | 📦 [в репо](https://github.com/OneCatalog/onecatalog-magento/blob/dev/docs/integration-answers.md) | 🚧 [onecatalog-magento](https://github.com/OneCatalog/onecatalog-magento) (в разработке, ветка `dev`) |
| Shopify (public app, Remix) | 📦 [в репо](https://github.com/OneCatalog/onecatalog-shopify/blob/dev/docs/integration-plan.md) | 📦 [в репо](https://github.com/OneCatalog/onecatalog-shopify/blob/dev/docs/integration-answers.md) | 🚧 [onecatalog-shopify](https://github.com/OneCatalog/onecatalog-shopify) (в разработке, ветка `dev`) |
| BigCommerce | ✅ | ✅ | 🔜 planned |
