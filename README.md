...
- 📄 **[INTEGRATION-STANDARD.md](INTEGRATION-STANDARD.md)** — сам стандарт (внешние
  контракты API, доменная модель/маппинг, слои архитектуры, инварианты, фоновая
  очередь, настройки, точки расширения, i18n, жизненный цикл, чек-лист переноса).
...
| 1С-Битрикс | 📦 [в репо](https://github.com/OneCatalog/onecatalog-bitrix/blob/main/docs/integration-plan.md) | 📦 [в репо](https://github.com/OneCatalog/onecatalog-bitrix/blob/main/docs/integration-answers.md) | 🚧 [onecatalog-bitrix](https://github.com/OneCatalog/onecatalog-bitrix) (в разработке) |
| Bitrix24 | ✅ | ✅ | 🔜 planned |
| PrestaShop | ✅ | ✅ | 🔜 planned |
| OpenCart | ✅ | ✅ | 🔜 planned |
| Magento 2 | ✅ | ✅ | 🔜 planned |
